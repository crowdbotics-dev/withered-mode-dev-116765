...
## Project Structure
    ...
    ├── withered_mode_dev_116765  # Django project configurations
...
1. Clone this repo and `cd withered_mode_dev_116765`
...
2. Clone this repo and `cd withered_mode_dev_116765`
