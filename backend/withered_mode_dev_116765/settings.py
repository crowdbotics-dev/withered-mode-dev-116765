"""
Django settings for withered_mode_dev_116765 project.
...
ROOT_URLCONF = 'withered_mode_dev_116765.urls'
...
WSGI_APPLICATION = 'withered_mode_dev_116765.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_mode_dev_116765 API",
    "DESCRIPTION": "API documentation for withered_mode_dev_116765 App",
    "VERSION": "v1",
}
